...
public:
	...
	enum class Command { findMinMax, findMax, findCentre };
	...
	virtual void execute(s21::ModelDate *data, Command command) = 0;
...
public:
	void execute(s21::ModelDate *data, Command command) override;
	void initMinMax(const s21::ModelDate::Coordinate &vertex);
	void update(Event *e);
};
